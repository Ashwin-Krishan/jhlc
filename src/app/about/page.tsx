...
export default function About() {
  return (
    <section className="max-w-4xl mx-auto px-4 py-12">
      ...
      <h2 className="text-xl font-semibold mt-8 mb-2">School History</h2>
      ...
      <h2 className="text-xl font-semibold mt-8 mb-2">Mission & Vision</h2>
      ...
      <h2 className="text-xl font-semibold mt-8 mb-2">Logo</h2>
      <div className="mb-4">
        <Image src="/images/logo.png" alt="School Logo" width={100} height={100} />
      </div>

      <h2 className="text-xl font-semibold mt-8 mb-2">Temple</h2>
      <p className="text-gray-700 mb-4">
      ...
      <h2 className="text-xl font-semibold mt-8 mb-2">Former Principals</h2>
